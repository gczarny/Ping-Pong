...
void __fastcall TForm1::FormCreate(TObject *Sender)
{
    if(gameStarted == false)
    {
        ShowMessage("Witaj w grze Ping-Pong!\n"
                ...
                "Im d³u¿ej odbijasz pi³kê, tym szybciej zacznie siê przemieszczaæ.\n\n"
                "Mi³ej zabawy!");
    }
    else
    {
...
void __fastcall TForm1::ballTimerTimer(TObject *Sender)
{
    if(gameStarted == true)
    {
                ...
                ball->Left > paddleP2->Left + paddleP2->Width)
        {
            ...
            bouncesNumberLabel->Caption = "Iloœæ odbiæ: " + IntToStr(ballBounces);
...
void __fastcall TForm1::newGameButtonClick(TObject *Sender)
{
    ...
    {
        if( Application->MessageBox("Jesteœ pewien, ¿e chcesz rozpocz¹ now¹ grê? "
                                    "utracisz zapisany stan gry.", "PotwierdŸ",
                                    MB_YESNO) == IDYES)
        {
            victoriesP1 = 0;
            victoriesP2 = 0;
